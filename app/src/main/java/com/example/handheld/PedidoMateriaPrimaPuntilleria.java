...
public class PedidoMateriaPrimaPuntilleria extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedido_materia_prima_puntilleria);
    ...
    public void consultarPedidos(){
        ...
        ListaPedidos = conexion.obtenerPedidosMateriaPrimaPuntilleria(getApplication());
        PedidoAdapter = new listpedidoAdapter(PedidoMateriaPrimaPuntilleria.this,R.layout.item_row,ListaPedidos);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        if (intPendiente > 0){
            Intent intent = new Intent(this,EscanerTrasladoMateriaPrimaPuntilleria.class);
