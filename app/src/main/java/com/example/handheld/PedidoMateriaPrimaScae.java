...
public class PedidoMateriaPrimaScae extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedido_materia_prima_scae);
        ...
        listviewPedido = findViewById(R.id.listviewPedidoMateriaPrimaScae);
    ...
    public void consultarPedidos(){
        ...
        ListaPedidos = conexion.obtenerPedidosMateriaPrimaScae(getApplication());
        PedidoAdapter = new listpedidoAdapter(PedidoMateriaPrimaScae.this,R.layout.item_row,ListaPedidos);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        if (intPendiente > 0){
            Intent intent = new Intent(this,EscanerTrasladoMateriaPrimaScae.class);
