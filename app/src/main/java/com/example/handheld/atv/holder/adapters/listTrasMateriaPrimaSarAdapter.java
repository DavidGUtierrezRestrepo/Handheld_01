...
public class listTrasMateriaPrimaSarAdapter extends ArrayAdapter<DetalleTranMateriaPrimaSarModelo> {

    private final List<DetalleTranMateriaPrimaSarModelo> mlist;
    private final Context mContext;
    private final int resourceLayout;

    public listTrasMateriaPrimaSarAdapter(@NonNull Context context, int resource, List<DetalleTranMateriaPrimaSarModelo> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        DetalleTranMateriaPrimaSarModelo modelo = mlist.get(position);
