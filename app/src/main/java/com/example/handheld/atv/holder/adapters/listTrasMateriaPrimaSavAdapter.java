...
public class listTrasMateriaPrimaSavAdapter extends ArrayAdapter<DetalleTranMateriaPrimaSavModelo> {

    private final List<DetalleTranMateriaPrimaSavModelo> mlist;
    private final Context mContext;
    private final int resourceLayout;

    public listTrasMateriaPrimaSavAdapter(@NonNull Context context, int resource, List<DetalleTranMateriaPrimaSavModelo> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        DetalleTranMateriaPrimaSavModelo modelo = mlist.get(position);
