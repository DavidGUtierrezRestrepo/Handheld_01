...
public class PedidoMateriaPrimaSar extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedido_materia_prima_sar);
        ...
        listviewPedido = findViewById(R.id.listviewPedidoMateriaPrimaSar);
    ...
    public void consultarPedidos(){
        ...
        ListaPedidos = conexion.obtenerPedidosMateriaPrimaSar(getApplication());
        PedidoAdapter = new listpedidoAdapter(PedidoMateriaPrimaSar.this,R.layout.item_row,ListaPedidos);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        if (intPendiente > 0){
            Intent intent = new Intent(this,EscanerTrasladoMateriaPrimaSar.class);
