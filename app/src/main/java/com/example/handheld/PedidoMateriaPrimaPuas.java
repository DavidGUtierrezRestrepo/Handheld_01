...
public class PedidoMateriaPrimaPuas extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedido_materia_prima_puas);
    ...
    public void consultarPedidos(){
        ...
        ListaPedidos = conexion.obtenerPedidosMateriaPrimaPuas(getApplication());
        PedidoAdapter = new listpedidoAdapter(PedidoMateriaPrimaPuas.this,R.layout.item_row,ListaPedidos);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        if (intPendiente > 0){
            Intent intent = new Intent(this,EscanerTrasladoMateriaPrimaPuas.class);
