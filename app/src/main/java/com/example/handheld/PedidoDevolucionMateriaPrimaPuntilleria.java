...
public class PedidoDevolucionMateriaPrimaPuntilleria extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedido_devolucion_materia_prima_puntilleria);
        ...
        listviewPedido = findViewById(R.id.listviewPedidoMateriaPrimaPuntilleria);
    ...
    public void consultarPedidos(){
        ...
        ListaPedidos = conexion.obtenerPedidosDevolucionMateriaPrimaPuntilleria(getApplication());
        PedidoAdapter = new listpedidoAdapter(PedidoDevolucionMateriaPrimaPuntilleria.this,R.layout.item_row,ListaPedidos);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        if (intPendiente > 0){
            Intent intent = new Intent(this,EscanerDevolucionMateriaPrimaPuntilleria.class);
