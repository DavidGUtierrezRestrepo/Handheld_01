...
public class PedidoMateriaPrimaSav extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedido_materia_prima_sav);
    ...
    public void consultarPedidos(){
        ...
        ListaPedidos = conexion.obtenerPedidosMateriaPrimaSav(getApplication());
        PedidoAdapter = new listpedidoAdapter(PedidoMateriaPrimaSav.this,R.layout.item_row,ListaPedidos);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        if (intPendiente > 0){
            Intent intent = new Intent(this,EscanerTrasladoMateriaPrimaSav.class);
