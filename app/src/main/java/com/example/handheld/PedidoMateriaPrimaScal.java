...
public class PedidoMateriaPrimaScal extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedido_materia_prima_scal);
        ...
        listviewPedido = findViewById(R.id.listviewPedidoMateriaPrimaScal);
    ...
    public void consultarPedidos(){
        ...
        ListaPedidos = conexion.obtenerPedidosMateriaPrimaScal(getApplication());
        PedidoAdapter = new listpedidoAdapter(PedidoMateriaPrimaScal.this,R.layout.item_row,ListaPedidos);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        if (intPendiente > 0){
            Intent intent = new Intent(this,EscanerTrasladoMateriaPrimaScal.class);
