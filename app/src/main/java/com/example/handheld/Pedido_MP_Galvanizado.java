...
public class Pedido_MP_Galvanizado extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedido_mp_galvanizado);
    ...
    private void mostrarConsulta() {
        ...
        ListaPedidos = conexion.obtenerPedidosGalvanizado(getApplication());
        PedidoAdapter = new listpedidoAdapter(Pedido_MP_Galvanizado.this,R.layout.item_row,ListaPedidos);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        if (intPendiente > 0){
            Intent intent = new Intent(this,Trans_MP_Galvanizado.class);
