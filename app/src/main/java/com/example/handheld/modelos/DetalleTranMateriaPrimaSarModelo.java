...
public class DetalleTranMateriaPrimaSarModelo {
    ...
    public DetalleTranMateriaPrimaSarModelo() {
    }

    public DetalleTranMateriaPrimaSarModelo(String nro_orden, String id_detalle, String numRollo, String codigo, String peso, String tipoTransa, String numTransa) {
