...
public class DetalleTranMateriaPrimaScaeModelo {
    String nro_orden;
    String id_detalle;
    String numRollo;
    String codigo;
    ...
    public DetalleTranMateriaPrimaScaeModelo() {
    }

    public DetalleTranMateriaPrimaScaeModelo(String nro_orden, String id_detalle, String numRollo, String codigo, String peso, String tipoTransa, String numTransa) {
