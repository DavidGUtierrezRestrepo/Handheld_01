...
public class DetalleTranMateriaPrimaSavModelo {
    ...
    public DetalleTranMateriaPrimaSavModelo() {
    }

    public DetalleTranMateriaPrimaSavModelo(String nro_orden, String id_detalle, String numRollo, String codigo, String peso, String tipoTransa, String numTransa) {
