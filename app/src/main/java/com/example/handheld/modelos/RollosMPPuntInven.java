...
public class RollosMPPuntInven {
    String cod_orden;
    String id_detalle;
    String id_rollo;
    String peso;
    ...
    public RollosMPPuntInven() {
    }

    public RollosMPPuntInven(String cod_orden, String id_detalle, String id_rollo, String peso, String codigo, String nombre, String fecha_hora, String destino, String traslado, String anulado, String manuales, String scla) {
