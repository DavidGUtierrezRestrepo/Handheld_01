...
public class RolloRecoTransa {
    ...
    public RolloRecoTransa() {
    }

    public RolloRecoTransa(String cod_orden, String id_detalle, String id_rollo, String estado, String fecha_recepcion, String trb1) {
