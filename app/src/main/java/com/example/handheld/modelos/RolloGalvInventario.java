...
public class RolloGalvInventario {
    String codigo;
    String nombre;
    String nro_orden;
    String nro_rollo;
    ...
    public RolloGalvInventario(String codigo, String nombre, String nro_orden, String nro_rollo, String tipo_trans, String traslado, String peso, String fecha_hora, String destino) {
        this.codigo = codigo;
        this.nombre = nombre;
